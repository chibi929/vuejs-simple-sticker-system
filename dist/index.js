const c = {
  ...
  computed: {
    stickerStyles() {
      return {
        "--src": `url(${this.src})`,
        "--srcWidth": `${this.srcWidth * this.scale}px`,
        "--srcHeight": `${this.srcHeight * this.scale}px`,
...
var s = function() {
  ...
  return C("div", { staticClass: "sticker-component", style: A.stickerStyles }, [C("div", { staticClass: "css-sprite", on: { click: A.onClickSticker } }, [A.locked ? C("img", { staticClass: "lock", attrs: { src: l, alt: "Locked" } }) : A._e()])]);
}, n = [], d = /* @__PURE__ */ t(
  c,
  s,
  n,
...
var k = function() {
  ...
  return C("div", { staticClass: "sticker-system-component", style: A.componentStyle }, [A.showStickerTable ? C("div", { staticClass: "background", on: { click: function(I) {
    ...
    return C("Sticker", { key: I.clientMutationId, attrs: { src: A.stickerConfig.filePath, srcWidth: A.stickerConfig.srcWidth, srcHeight: A.stickerConfig.srcHeight, gridX: A.optimizedStickers[I.stickerId].gridX, gridY: A.optimizedStickers[I.stickerId].gridY, gridWidth: A.stickerConfig.gridWidth, gridHeight: A.stickerConfig.gridHeight, scale: A.actualStickerSize / A.stickerConfig.gridWidth, position: A.randomId === I.senderId ? "right" : "left" } });
    ...
    return [A.useLockedIcon || I.unlocked ? C("Sticker", { key: I.stickerId, attrs: { src: A.stickerConfig.filePath, srcWidth: A.stickerConfig.srcWidth, srcHeight: A.stickerConfig.srcHeight, gridX: I.gridX, gridY: I.gridY, gridWidth: A.stickerConfig.gridWidth, gridHeight: A.stickerConfig.gridHeight, scale: A.actualStickerSize / A.stickerConfig.gridWidth, locked: !I.unlocked, "data-sticker-id": I.stickerId }, on: { click: function(r) {
